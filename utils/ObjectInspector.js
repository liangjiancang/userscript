/**
 * 对象观察器，根据 `regex` 在 `depth` 层深度内找到匹配 `regex` 的属性
 * 
 * @constructor
 ...
 * @version 1.0.0.20200719
 */
function ObjectInspector(obj, regex, config) {
  var defaultConfig = {
    depth: 5,
    inspectKey: true,
    inspectValue: true,
 ...
 */
ObjectInspector.prototype.inspectObject = function(config) {
 ...
 */
ObjectInspector.prototype._inspectObjectInner = function({ obj, regex, inspectKey, inspectValue, exRegex, exLongStrLen }, depth, result, prevKey, objSet) {
  for (var key in obj) {
