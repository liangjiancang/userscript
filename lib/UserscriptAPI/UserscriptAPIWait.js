...
class UserscriptAPIWait {
  ...
  executeAfterElementLoaded(options) {
    ...
    function initInsertUnrealElementEventDispatcher() {
      if (unsafeWindow[Symbol.for('insert-unreal-element-event-dispatcher')] === undefined) {
        ...
        unsafeWindow[Symbol.for('insert-unreal-element-event-dispatcher')] = true
      }
    }
  }
